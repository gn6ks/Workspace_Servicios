...
public class probabilidadColision {
    public static int calcularProbabilidad(double posicioNEO, double velocitatNEO) {
        ...
        double resultat = 100 * Math.random() * Math.pow(((posicioNEO - posicioTerra) / (posicioNEO + posicioTerra)), 2);
        return (int) resultat;
    }
    ...
    public static void main(String[] args) {
        ...
        int resultado = calcularProbabilidad(posicionNeo, velocidadNeo); // calcular probabilidad
